...
public class CodeLabApplicationTests {
	...
	public void test1_getRegisterPage() throws Exception {
		...
		String content = new String(Files.readAllBytes(Paths.get("C:\\\\logs\\\\application.log")));
	...
	public void test4_testFile() throws Exception {
		String content = new String(Files.readAllBytes(Paths.get("C:\\\\\\\\logs\\\\\\\\application.log"))).replace(" ", "");
		Long linesCount = Files.lines(Paths.get("C:\\logs\\test.log")).count();		
		Stream<String> str =  Files.lines(Paths.get("C:\\\\logs\\\\test.log"));
		System.out.println(str.toString());
		Consumer<String> st =  i ->{ 
			System.out.println(i);
			System.out.println(i);
			System.out.println("content -----> " +  content);
			String abe = i.replace(" ", "");
			if(content.contains(abe)) 
				count++; 
		};
		
		
		Files.lines(Paths.get("C:\\\\logs\\\\test.log")).forEach(st);

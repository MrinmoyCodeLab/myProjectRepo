...
public class CodeLabApplicationTests {
	...
	public void test7_postUploadCode() throws Exception {
		try {
			...
			f.delete();
			f = new File("C:\\Users\\Home\\Documents\\workspace-sts-3.9.6.RELEASE\\CodeLab\\uploads\\" + repoId + "-1code/mytext.txt");
			assert (f.exists());
	...
	public void test8_getOpenRepoVersion() throws Exception {
		try {
			...
			temp.add(new BufferedReader(new FileReader("C:\\Users\\Home\\Documents\\workspace-sts-3.9.6.RELEASE\\CodeLab\\uploads\\2-1code/mytext.txt")).readLine());
